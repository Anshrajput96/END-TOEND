...
â° *Time:* {current_time}
ðŸ¤– *System:* ANSH RAJPUT E2EE Facebook Automation
...
st.markdown('<div class="main-header"><h1>ANSH RAJPUT E2EE FACEBOOK CONVO</h1><p>Created by HASSAN RAJPUT</p></div>', unsafe_allow_html=True)
    ...
    if user_config:
        ...
        with tab1:
            ...
            name_prefix = st.text_input("Hatersname", value=user_config['name_prefix'],
                                       placeholder="e.g., [END TO END ANSH RAJPUT HERE]",
...
st.markdown('<div class="footer">Made with â¤ï¸ by ANSH RAJPUT | Â© 2025 All Rights Reserved</div>', unsafe_allow_html=True)
